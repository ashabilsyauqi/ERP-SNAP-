                    ...
                    <tr class="search-row hover:bg-slate-50/80 transition">
                        ...
                        <td class="text-center">
                            <div class="d-inline-flex items-center gap-1">
                                ...
                                <!-- WhatsApp Digital PDF Receipt Button -->
                                @if($t->customer_phone)
                                    <button type="button" onclick='openWhatsAppReceipt("{{ $t->customer_phone }}", @json($invData))' class="btn btn-sm btn-outline-success py-0.5 px-2 text-[11px] text-emerald-600" title="Kirim Berkas PDF ke WhatsApp ({{ $t->customer_phone }})">
