            ...
            <table class="table table-hover o_list_table mb-0" id="main-table">
                ...
                <tfoot>
                    <tr class="fw-bold bg-slate-100 border-top">
                        <td colspan="4" class="ps-3 text-uppercase">Total Pengeluaran Kas Keluar</td>
                        <td class="text-end pe-4 font-mono text-rose-800 fs-6">- Rp {{ number_format($totalKeluar, 0, ',', '.') }}</td>
                    </tr>
                </tfoot>
                @endif
            </table>
