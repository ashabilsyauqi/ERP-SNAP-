...
@section('page-title', 'Buku Kas (Mutasi)')

@section('content')

<!-- Filter -->
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
    <form method="GET" action="{{ route('reports.cash-mutation') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
        <div>
        ...
        <div>
            ...
            <select name="tipe" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 text-sm">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('reports.cash-mutation') }}" class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 focus:outline-none">
                Reset
            </a>
        </div>
    </form>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="p-6 border-b border-gray-100 bg-gray-50/30 flex justify-between items-center">
        <h3 class="text-lg font-bold text-gray-900">Detail Mutasi Kas</h3>
