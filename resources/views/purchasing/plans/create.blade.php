...
@section('title', 'Buat Purchase Plan Baru')
...
<div class="max-w-5xl mx-auto" x-data="purchasePlanForm()" id="plan-form-container">
    ...
    <div class="o_form_sheet p-4 bg-white shadow-sm border rounded">
        ...
        <div class="mb-4 pb-3 border-bottom d-flex justify-content-between align-items-start">
            <div>
                <h4 class="fw-bold text-slate-900 mb-1">Rencana Pengadaan (Purchase Plan Bundle)</h4>
                <p class="text-xs text-slate-500 mb-0">Susun bundle daftar produk/material dan rincian biaya untuk persetujuan Owner.</p>
            </div>
        ...
        <form action="{{ route('purchasing.plans.store') }}" method="POST" id="purchase-plan-form" class="space-y-4">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="title" required placeholder="Contoh: Restok Bahan Cetak & Banner Bulanan" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="{{ auth()->user()->isOwner() ? 'md:col-span-2' : 'md:col-span-3' }}">
                    ...
                    <input type="text" name="notes" placeholder="Contoh: Kebutuhan cetak promo akhir bulan & stok menipis" 
                        class="form-control form-control-sm">
                </div>
            </div>
